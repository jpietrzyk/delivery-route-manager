...
describe('RouteManager', () => {
  ...
  beforeEach(() => {
    ...
    mockMapProvider = {
      ...
      createRouteSegment: jest.fn().mockResolvedValue({
        polyline: [[51.505, -0.09], [51.51, -0.1]],
        distance: 1000,
        duration: 60,
        bounds: { minLat: 51.505, minLng: -0.1, maxLat: 51.51, maxLng: -0.09 },
        status: 'calculated',
        calculatedAt: new Date(),
      }),
      drawRouteSegment: jest.fn().mockReturnValue({
        id: 'route-mock-id',
        segmentId: '',
        nativeRoute: {},
        color: '#2563eb',
