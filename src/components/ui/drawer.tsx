    ...
    <DrawerPortal>
      ...
      >
        ...
        <DrawerPrimitive.Close
          ...
          className="absolute right-4 top-4 rounded-md bg-background/80 p-1.5 opacity-70 ring-offset-background transition-opacity hover:bg-accent hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none"
        >
